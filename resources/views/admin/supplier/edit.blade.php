                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('admin.supplier.update', $supplierData->id) }}"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="type"
                                                    ...
                                                    <option value="Distributor"
                                                        {{ $supplierData->type == 'Distributor' ? 'selected' : '' }}>
                                                        Distributor </option>
                                                    <option value="Whole Seller"
                                                        {{ $supplierData->type == 'Whole Seller' ? 'selected' : '' }}>Whole
                                                        Seller </option>
                                                </select>
                                                @error('type')
                                                    <span class="text-danger"> {{ $message }} </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="account_holder"
                                                    ...
                                                    value="{{ $supplierData->account_holder }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="bank_branch"
                                                    ...
                                                    value="{{ $supplierData->bank_branch }}">
                                                @error('bank_branch')
                                                    <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <img id="showImage" src="{{ asset($supplierData->image) }}"
